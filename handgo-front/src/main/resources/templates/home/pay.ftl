    ...
    <div class="paycont">
            ...
            <ul>
                <div class="per-border"></div>
							<#list address as addr>
                                <#if (addr.isPrimary == 1)>
                            <li class="user-addresslist" @click="clickAddr(${addr_index})" :class="{defaultAddr:defAddr==${addr_index}}">
                                <#else>
                            <li class="user-addresslist" @click="clickAddr(${addr_index})" :class="{defaultAddr:defAddr==${addr_index}}">
                                </#if>
        ...
        <div class="logistics">
            ...
            <ul class="op_express_delivery_hot">
                <li data-value="yuantong" class="OP_LOG_BTN  " @click="changeExpress(0)" :class="{selected:selectedEx==0}"><i class="c-gap-right"
                                                                  style="background-position:0px -468px"></i>圆通<span></span>
                </li>
                <li data-value="shentong" class="OP_LOG_BTN  " @click="changeExpress(1)" :class="{selected:selectedEx==1}"><i class="c-gap-right"
                                                                  style="background-position:0px -1008px"></i>申通<span></span>
                </li>
                <li data-value="yunda" class="OP_LOG_BTN  " @click="changeExpress(2)" :class="{selected:selectedEx==2}"><i class="c-gap-right"
                                                               style="background-position:0px -576px"></i>韵达<span></span>
                </li>
                <li data-value="zhongtong" class="OP_LOG_BTN op_express_delivery_hot_last " @click="changeExpress(3)" :class="{selected:selectedEx==3}"><i class="c-gap-right"
                                                                                               style="background-position:0px -324px"></i>中通<span></span>
                </li>
                <li data-value="shunfeng" class="OP_LOG_BTN  op_express_delivery_hot_bottom" @click="changeExpress(4)" :class="{selected:selectedEx==4}"><i class="c-gap-right"
                    ...
                    <div class="bundle  bundle-last">
                        ...
                        <div class="bundle-main">
                            <ul class="item-content clearfix">
                                ...
                                <li class="td td-amount">
                                    <div class="amount-wrapper ">
                                        <div class="item-amount ">
                                            ...
                                            <div class="sl">
                                                <input class="min am-btn" @click="productChange(-1)" name="" type="button" value="-"/>
                                                <input v-model="productNumber" class="text_box" name="" type="text" value="3"
                                                       style="width:30px;"/>
                                                <input class="add am-btn" @click="productChange(1)" name="" type="button" value="+"/>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                                <li class="td td-sum">
                                    <div class="td-inner">
                                        <em tabindex="0" class="J_ItemSum number">{{singleSum}}</em>
                                    </div>
                                </li>
        ...
        <div class="buy-point-discharge ">
            <p class="price g_price ">
                合计（含运费） <span>¥</span><em class="pay-sum">{{singleSum}}</em>
            </p>
        </div>
                ...
                <div class="box">
                    <div tabindex="0" id="holyshit267" class="realPay"><em class="t">实付款：</em>
                        <span class="price g_price ">
                                    <span>¥</span> <em class="style-large-bold-red " id="J_ActualFee">{{singleSum}}</em>
											</span>
                    </div>
